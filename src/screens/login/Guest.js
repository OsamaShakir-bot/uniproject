...
render() {
    ...
    <ScrollView style={{paddingBottom:40}}>
        ...
        <View>
      <View source={require('./../../../assets/loginback.png')} style={{alignItems:'center',justifyContent:'center',height:220,width:'100%'}}>
  ...
  <Item regular style={{alignSelf:'center',marginTop:10,marginLeft:20,marginVertical:10,marginHorizontal:20,borderRadius:5}}>
         ...
         >
              <Text style={{color:'white' ,fontSize:18,alignSelf:'center'}}>Continue</Text>
          </Button>
